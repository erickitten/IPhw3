...
IPhw3Dlg.h、IPhw3Dlg.cpp - 對話方塊
    這些檔案包含您的 CIPhw3Dlg 類別。這個類別會定義應用程式主對話方塊的行為。對話方塊的範本是在可於 Microsoft Visual C++ 編輯的 IPhw3.rc 中。
...
StdAfx.h, StdAfx.cpp
    這些檔案是用來建置名為 IPhw3.pch 的先行編譯標頭 (PCH) 檔，以及名為 StdAfx.obj 的先行編譯型別檔。
